"""approver_24202 URL Configuration
...
admin.site.site_header = "Approver"
admin.site.site_title = "Approver Admin Portal"
admin.site.index_title = "Approver Admin"

# swagger
api_info = openapi.Info(
    title="Approver API",
    default_version="v1",
    description="API documentation for Approver App",
)
